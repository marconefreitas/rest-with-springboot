...
public class User implements Serializable, UserDetails {
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(isAccountNonExpired());
        result = 31 * result + Objects.hashCode(isAccountNonLocked());
        result = 31 * result + Objects.hashCode(isCredentialsNonExpired());
        result = 31 * result + Objects.hashCode(isEnabled());
